...
{
    public partial class EditFriendPhoto
    {
        [Inject]
        ...
        {
            friendPhoto = await ConDataService.GetFriendPhotoByPhotoId(photoId:PhotoID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await ConDataService.UpdateFriendPhoto(photoId:PhotoID, friendPhoto);
